 ...
 */
SEXP CALL_EHHS(SEXP data_, SEXP nbr_chr_, SEXP nbr_mrk_, SEXP foc_mrk_, SEXP lim_haplo_, SEXP lim_ehhs_,
		SEXP phased_) {
	...
	//perform calculation
	calc_ehhs(data, nbr_chr, nbr_mrk, foc_mrk, lim_haplo, lim_ehhs, phased, nhaplo_eval, ehhs, nehhs);
